...
export task_ls=("Anthropic/hh-rlhf@fingerprint")
...
do
	...
	do
		...
		export save_path="${POD_save_dir}rebuttal_fingerprint_safety_align${task}${train_num}${train_time}${train_task}"
...
echo "RUNNING 6.9.rebuttal_fingerprint.sh DONE."
# 6.9.rebuttal_fingerprint.sh ends here
