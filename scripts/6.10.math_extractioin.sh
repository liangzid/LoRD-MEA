...
export POD_save_dir="${root_dir}/math_ckpts/"
...
do
	...
	do
		...
		export save_path="${POD_save_dir}math_reasoning${task}${train_num}${train_time}${train_task}"
...
echo "RUNNING 6.10.math_extractioin.sh DONE."
# 6.10.math_extractioin.sh ends here
