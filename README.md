...
The original code comes from [here](https://github.com/jwkirchenbauer/lm-watermarking). All rights are reserved for the original repository.

<img
  src="./images/wm-ex.png"
  style="display: inline-block; margin: 0 auto; max-width: 300px">
...
<img
  src="./images/querytime-ex.png"
  style="display: inline-block; margin: 0 auto; max-width: 300px">


<img
  src="./images/model-ex.png"
  style="display: inline-block; margin: 0 auto; max-width: 300px">
