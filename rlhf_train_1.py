...
class ScriptArguments:
    use_seq2seq: bool = field(default=False, metadata={
                              "help": "whether to use seq2seq"})
    trust_remote_code: bool = field(default=False, metadata={
                                    "help": "Enable `trust_remote_code`"})
    reward_model_path: str = field(metadata={"help": "pth of reward model"})

    # LoraConfig
    use_peft: bool = field(default=False, metadata={
...
ppo_trainer = PPOTrainer(ppo_config, model, ref_model,
...
print(f"task: {task}, modelname: {model_name}")
